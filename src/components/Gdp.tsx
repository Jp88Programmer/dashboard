...
import { urlForGdpCapita, urlForFixedCapitalFormation, urlForGdpGrowth, urlForGdp, urlForGdpPerCapitaGrowth, urlForGdpForPpp } from '../constants/gdp';
    ...
    return (
        <div className='flex flex-col gap-4 p-4'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <MyBarChart url={urlForGdp} yearNo={yearNos[0]} title="GDP (current US$)" />
            </div>
            ...
            <div className='flex flex-col gap-4'>
                <div className='flex flex-col gap-2 md:text-base text-sm'>
                    <div className='text-lg font-medium'>Gross fixed capital formation (% of GDP)</div>
                    <div>
                ...
                <MyBarChart url={urlForFixedCapitalFormation} yearNo={yearNos[2]} title="Gross fixed capital formation (% of GDP)" />
            </div>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <MyLineChart url={urlForGdpGrowth} yearNo={yearNos[3]} title="GDP growth (annual %)" />
            </div>

            {/* GDP per capita growth (annual %) */}
            <div className='flex flex-col gap-4'>
                <div className='flex flex-col gap-2 md:text-base text-sm'>
                    <div className='text-lg font-medium'>GDP per capita growth (annual %)</div>
                    <div>
                ...
                <MyBarChart url={urlForGdpPerCapitaGrowth} yearNo={yearNos[4]} title="GDP per capita growth (annual %)" />
            </div>

            {/* GDP Purchasing Power Parity (PPP) */}
            <div className='flex flex-col gap-4'>
                <div className='flex flex-col gap-2 md:text-base text-sm'>
                    <div className='text-lg font-medium'>GDP Purchasing Power Parity (PPP)</div>
                    <div>
                ...
                <MyLineChart url={urlForGdpForPpp} yearNo={yearNos[5]} title="GDP Purchasing Power Parity (PPP)" />
            </div>
        </div>
    );
};
